...
(function () {
    ...
    foreach ($aUsers as $aUser) {
        if ($_POST['email']  ==  $aUser->email && password_verify($_POST['password'], $aUser->password)) {
...
<body>
    <div id="wrap">
        ...
        <form method="POST" action="login.php">
            <input id="userEmail" name="email" type="email" placeholder="E-mail" value="">
            <input id="userPassword" name="password" type="password" placeholder="Password" value="">
